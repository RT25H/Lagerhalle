...
namespace MemeCreator
{
	...
	public partial class BorderLabel : Label
	{
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			sf.LineAlignment = TextAlign == ContentAlignment.BottomCenter ? StringAlignment.Far : StringAlignment.Near;

			this.drawPath.Reset();
			this.drawPath.AddString(this.Text, this.Font.FontFamily, (int)this.Font.Style, fontSize,
				new Rectangle(Point.Empty, this.Size), sf);
